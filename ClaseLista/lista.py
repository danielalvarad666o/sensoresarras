from crearjson import newJson

class Lista(newJson.Jsonn):    
    def __init__(self): 
       self.lista=[]
       
    def guardar(self,dicionario,nombre):
       self.agregarproducto(dicionario,nombre)
    ...
    def datosdeljson(self,elnombredelarchivo):
     return super().datosdeljson1(elnombredelarchivo)
    
   
         
       
    def eliminar(self,lista,elcaracter):
       posicion=0
       existe=False
